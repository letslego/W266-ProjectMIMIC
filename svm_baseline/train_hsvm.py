...
parser = argparse.ArgumentParser(description='Train Hierarchical SVM Model.')
parser.add_argument('-training_text', default='data/training_text.data', help='File location containing training text.')
parser.add_argument('-training_codes', default='data/training_codes.data', help='File location containing training codes.')
parser.add_argument('-ICD9_tree',  default='data/MIMIC_parentTochild', help='File location containing the ICD9 codes.')
parser.add_argument('-output_directory', default='hsvm_model/', help='Directory to save svm model files to.')
